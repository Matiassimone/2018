        ...
        methods : {
            checkForm : function () {
                if (this.persona.nombre && this.persona.apellido && this.persona.sexo && this.persona.edad && this.persona.edad<150 && this.persona.edad>0) {
                    ...
                    this.toEmit.nombre = this.persona.nombre;
                    this.toEmit.apellido = this.persona.apellido;
                    this.toEmit.sexo = this.persona.sexo;
                    this.toEmit.edad = this.persona.edad;

                    this.$emit('addNewPersona', this.toEmit);
